    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-content block-content-full">
                <form method="post"
                      action="{{ $item->id ? route('inspector.assets.resources.update', ['id' => $item->id]) : route('inspector.assets.resources.create') }}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <label for="name" class="form-label">{{ __('inspector.assets.resources.form.name') }}</label>
                        ...
                        <div class="col-md-4 col-12">
                            <label for="owner" class="form-label">{{ __('inspector.assets.resources.form.owner') }}</label>
                        ...
                        <div class="col-md-4 col-12">
                            <label for="status" class="form-label">{{ __('inspector.assets.resources.form.status') }}</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <label for="description" class="form-label">{{ __('inspector.assets.resources.form.description') }}</label>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3 col-12">
                            <label for="type" class="form-label">{{ __('inspector.assets.resources.form.type') }}</label>
                        ...
                        <div class="col-md-3 col-12">
                            <label for="security" class="form-label">{{ __('inspector.assets.resources.form.security') }}</label>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('inspector.assets.resources.index') }}" class="btn btn-outline-danger btn-sm">{{ __('trans.cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
