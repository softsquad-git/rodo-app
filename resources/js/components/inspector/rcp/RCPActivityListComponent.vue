        ...
        <div class="block-content block-content-full">
            ...
            <table v-if="data.data.length > 0 " class="table table-bordered table-striped table-vcenter">
                ...
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell" style="width: 30%;">Powiązane zbiory</th>
                    <th class="d-none d-sm-table-cell" style="width: 30%;">Podstawa przetwarzania</th>
                ...
                <tr v-for="(item, index) in data.data">
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <a :href="`/inspector/rcp/activities/update/${item.id}`"
