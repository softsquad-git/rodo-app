        ...
        <div class="block-content block-content-full">
            ...
            <table v-if="data.data.length > 0 " class="table table-bordered table-striped table-vcenter">
                ...
                <tr v-for="(item, index) in data.data">
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <a :href="`/inspector/assets/resources/update/${item.id}`"
...
export default {
    ...
    methods: {
        ...
        loadStatuses() {
            this.$axios.get(`/inspector/api/get-statuses?resource_type=resource`)
                .then((data) => {
        ...
        remove(id) {
            this.$swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$axios.delete(`/inspector/api/assets/resources/remove/${id}`)
                        .then((data) => {
