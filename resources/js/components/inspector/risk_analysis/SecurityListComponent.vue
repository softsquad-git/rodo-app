        ...
        <div class="block-content block-content-full">
            <div class="row mb-3">
                ...
                <div class="col-md-11 col-12">
                    <div class="row" v-if="isSearchBox">
                        ...
                        <div class="col-md-3">
                            <input type="text" v-model="filters.symbol" placeholder="Numer" class="form-control form-control-sm form-control-alt">
                        </div>
                        <div class="col-md-3">
            ...
            <table v-if="data.data.length > 0 " class="table table-bordered table-striped table-vcenter">
                ...
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell" style="width: 30%;">Rodzaj</th>
                ...
                <tr v-for="(item, index) in data.data">
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <a :href="`/inspector/risk-analysis/security/update/${item.id}`"
...
export default {
    ...
    methods: {
        ...
        loadStatuses() {
            this.$axios.get(`/inspector/api/get-statuses?resource_type=security`)
                .then((data) => {
        ...
        remove(id) {
            this.$swal.fire({
                type: 'warning',
                title: 'Jesteś pewien?',
                text: 'Czy na pewno chcesz usunąć zabezpieczenie?',
                ...
                if (result.isConfirmed) {
                    this.$axios.delete(`/inspector/api/risk-analysis/security/remove/${id}`)
                        .then((data) => {
