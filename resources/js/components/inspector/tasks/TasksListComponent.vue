            ...
            <div class="row mb-3">
                ...
                <div class="col-md-11 col-12">
                    <div class="row" v-if="isSearchBox">
                        ...
                        <div class="col-md-2">
                            <input type="datetime-local" v-model="filters.deadline" v-b-tooltip.hover title="Termin do" placeholder="Termin do" class="form-control form-control-alt form-control-sm">
                        </div>
                        <div class="col-md-2">
