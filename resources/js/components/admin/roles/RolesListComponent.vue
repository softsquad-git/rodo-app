        ...
        <div class="block-content block-content-full">
            <table v-if="data.data.length > 0 " class="table table-bordered table-striped table-vcenter">
                ...
                <tr v-for="(item, index) in data.data">
                    ...
                    <td class="text-right">
                        <div class="btn-group">
                            <a href="" class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title=""
    ...
    methods: {
        ...
        remove(id) {
            this.$swal.fire({
                type: 'warning',
                title: 'Jesteś pewien?',
                text: 'Czy na pewno chcesz usunąć rolę?',
                ...
                if (result.isConfirmed) {
                    this.$axios.delete(`/administration/api/roles/remove/${id}`)
                        .then((data) => {
