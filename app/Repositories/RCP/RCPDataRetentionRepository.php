...
class RCPDataRetentionRepository
{
    /**
     * @param int $id
     * @return RCPDataRetention|null
     */
    public function find(int $id): ?RCPDataRetention
    {
        return RCPDataRetention::find($id);
    }
    ...
    {
        $data = RCPDataRetention::orderBy($orderingColumn, $orderingSort);
